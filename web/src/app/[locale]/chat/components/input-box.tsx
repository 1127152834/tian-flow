        ...
        <div className="flex grow gap-2">
              ...
              title={
                <div>
                  <h3 className="mb-2 font-bold">
                    {t('chat.input.deepThinkingMode', {
                      status: enableDeepThinking ? t('chat.input.on') : t('chat.input.off')
                    })}
                  </h3>
                  <p>
                    {t('chat.input.deepThinkingTooltip', { model: reasoningModel })}
                  </p>
                </div>
              }
            >
              ...
              >
                <Lightbulb /> {t('chat.input.deepThinking')}
              </Button>
            </Tooltip>
          )}
          ...
          <Tooltip
            ...
            title={
              <div>
                <h3 className="mb-2 font-bold">
                  {t('chat.input.investigationMode', {
                    status: backgroundInvestigation ? t('chat.input.on') : t('chat.input.off')
                  })}
                </h3>
                <p>
                  {t('chat.input.investigationTooltip')}
                </p>
              </div>
            }
          >
            ...
            >
              <Detective /> {t('chat.input.investigation')}
            </Button>
          </Tooltip>
          <ReportStyleDialog />
        </div>
        <div className="flex shrink-0 items-center gap-2">
          <Tooltip title={t('chat.input.enhancePrompt')}>
            <Button
              variant="ghost"
              size="icon"
              className={cn(
          ...
          <Tooltip title={responding ? t('chat.input.stop') : t('chat.input.send')}>
            <Button
              variant="outline"
              size="icon"
