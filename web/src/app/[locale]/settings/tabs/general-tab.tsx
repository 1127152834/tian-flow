...
export const GeneralTab: Tab = ({
  ...
  const generalFormSchema = z.object({
    ...
    maxPlanIterations: z.number().min(1, {
      message: t('settings.general.validationErrors.minPlanIterations'),
    }),
    maxStepNum: z.number().min(1, {
      message: t('settings.general.validationErrors.minSteps'),
    }),
    maxSearchResults: z.number().min(1, {
      message: t('settings.general.validationErrors.minSearchResults'),
    }),
    // Others
  ...
  return (
    <div className="flex flex-col gap-4">
      <header>
        <h1 className="text-lg font-medium">{t('settings.general.title')}</h1>
      </header>
      <main>
        <Form {...form}>
          <form className="space-y-8">
                  ...
                  <FormControl>
                    <div className="flex items-center gap-2">
                      ...
                      <Label className="text-sm" htmlFor="autoAcceptedPlan">
                        {t('settings.general.autoAcceptPlan')}
                      </Label>
                    </div>
                  </FormControl>
                </FormItem>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>{t('settings.general.maxPlanIterations')}</FormLabel>
                  <FormControl>
                    <Input
                      className="w-60"
                      type="number"
                  ...
                  <FormDescription>
                    {t('settings.general.maxPlanIterationsDescription')}
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>{t('settings.general.maxSteps')}</FormLabel>
                  <FormControl>
                    <Input
                      className="w-60"
                      type="number"
                  ...
                  <FormDescription>
                    {t('settings.general.maxStepsDescription')}
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>{t('settings.general.maxSearchResults')}</FormLabel>
                  <FormControl>
                    <Input
                      className="w-60"
                      type="number"
                  ...
                  <FormDescription>
                    {t('settings.general.maxSearchResultsDescription')}
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
