      ...
      {!isReplay ? (
        <div className="relative flex h-42 shrink-0 pb-4">
          {!responding && messageCount === 0 && (
            <ConversationStarter
              className="absolute top-[-218px] left-0 right-0 w-full"
              onSend={handleSend}
            />
          )}
          <InputBox
                ...
                <div className="flex flex-grow items-center">
                  ...
                  <CardHeader className={cn("flex-grow", responding && "pl-3")}>
                    ...
                    <CardDescription>
                      <RainbowText animated={responding}>
                        {responding
                          ? "Olight is now replaying the conversation..."
                          : replayStarted
                            ? "The replay has been stopped."
                            : `You're now in Olight's replay mode. Click the "Play" button on the right to start.`}
                      </RainbowText>
                    </CardDescription>
                  </CardHeader>
                </div>
