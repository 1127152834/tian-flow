    ...
    try:
        ...
        if task.state == 'PENDING':
            ...
            response = {
                ...
                "current_step": task.info.get('details', {}).get('current_step', ''),
                "total_steps": task.info.get('details', {}).get('total_steps', 0),
                "processed_items": task.info.get('details', {}).get('processed_items', 0),
                "total_items": task.info.get('details', {}).get('total_items', 0)
            }
