    ...
    <div className="flex flex-col gap-4">
      <header>
        <div className="flex items-center justify-between gap-2">
          <h1 className="text-lg font-medium">{t('settings.mcp.title')}</h1>
            ...
            return (
              ...
              >
                <div className="absolute top-3 right-2">
                  <Tooltip title={t('settings.mcp.actions.enableDisable')}>
                ...
                <div className="absolute top-1 right-12 opacity-0 transition-opacity duration-300 group-hover:opacity-100">
                  <Tooltip title={t('settings.mcp.actions.deleteServer')}>
                    <Button
                      variant="ghost"
                      size="icon"
